...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/cdb-implementation-guidance/1.2
|Internal reference number of this OGC(R) document:        16-006r5
|Version: 1.2
