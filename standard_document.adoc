:Title: Volume 10: OGC CDB Implementation Guidance (Best Practice)
:titletext: Volume 10: OGC CDB Implementation Guidance (Best Practice)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/cdb-implementation-guidance/1.3
|Internal reference number of this OGC(R) document:        16-006rX
|Version: 1.3
|Category: OGC® Best Practice
|Editors:      Carl Reed, Sara Saeedi, Sina Kiaei
|===
...
include::clause_5_platform_requirements.adoc[]

include::clause_6_informative_implementation_guidance.adoc[]

include::clause_7_shapefile_dbase_iii_guidance.adoc[]

include::clause_8_tiff_implementation_guidance.adoc[]

include::clause_9_cdb_nas_attribute_mapping.adoc[]
...
include::annex_C_sofwerx_attributions_subgroup.adoc[]
include::annex_D_traditional_cdb_attribution.adoc[]
